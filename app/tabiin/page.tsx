  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setItems(all.filter((item) => isTabiin(item.generation)));
      } catch (error) {
        console.error('Tabiin listesi yüklenemedi:', error);
      } finally {
        setLoading(false);
      }
    };
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-2xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-foreground">Tabiin</h1>
              </div>
              <p className="text-muted-foreground text-lg mb-6">Sahabeleri gören ve onlardan ilim alan mübarek nesil.</p>
        ...
        <section className="py-8">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-foreground">Tüm Tabiin</h2>
