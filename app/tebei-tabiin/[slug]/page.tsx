...
export default function TebeiTabiinDetailPage() {
  ...
  useEffect(() => {
    ...
    async function loadItem() {
      try {
        ...
        if (data.sahabe && isTebeiTabiin(String(data.sahabe.generation || ''))) {
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-foreground mb-4">Tebei Tabiin Bulunamadı</h1>
